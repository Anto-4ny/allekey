...
const travelPackages = {
  ...
  "samburu": [
    {
      name: "Saruni Samburu Safari Retreat",
      image: "img/saruni.jpg",
      description: "Stay in a luxury villa on a rocky outcrop with sweeping views. Includes full-board and private guides.",
      price: "$1,050 / Night",
      location: "Kalama Conservancy, Samburu"
    },
    {
      name: "Elephant Watch Camp Adventure",
      image: "img/elephant-camp.jpg",
      description: "Eco-luxury tented camp focused on elephant conservation. Offers bush walks and Samburu cultural tours.",
      price: "$980 / Night",
      location: "Samburu National Reserve"
    },
    {
      name: "Fly-in Safari to Buffalo Springs",
      image: "img/buffalo-springs.jpg",
      description: "All-inclusive fly-in package to Buffalo Springs with exclusive game drives and chef-prepared meals.",
      price: "$1,200 / Person",
      location: "Buffalo Springs, Samburu"
    }
  ]
};

// Export or use this object in other scripts
